...
public abstract class BaseBleDevice {
     ...
     * 服务 UUID
     */
    protected UUID serviceUuid = UUID.fromString("55535343-fe7d-4ae5-8fa9-9fafd205e455");
    /**
     * 写数据 UUID
     */
    protected UUID writeUuid = UUID.fromString("49535343-8841-43f4-a8d4-ecbe34729bb3");
    /**
     * 读数据 UUID
     */
    protected UUID notifyUuid = UUID.fromString("49535343-1e4d-4bd9-ba61-23c647249616");
